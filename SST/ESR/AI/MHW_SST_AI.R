...
png("AI/2022/Figure_1_SST_AI_ESR_crwsst.png",width=6,height=3.375,units="in",res=300)
...
png("AI/2022/Figure_2_SST_AI_ESR_TimeSeries_updated.png",width=6,height=4,units="in",res=300)
df %>% 
...
png("AI/2022/Figure_4_MHW_days_season_updated.png",width=6,height=3.375,units="in",res=300)
annualevents %>% 
