...
Spring_Chlorophylla_Peak_WCGOA_Satellite<-dbGetQuery(con_j, "WITH ranked_data AS (
    SELECT
         year,
         doy,
        meanchla,
...
write.csv(Spring_Chlorophylla_Peak_WCGOA_Satellite%>% add_submission_year() ,"ESP/2025_indicators/Spring_Chlorophylla_Peak_WCGOA_Satellite.csv",  row.names = FALSE)
