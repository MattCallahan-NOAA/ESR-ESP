...
# 
f23 <- readRDS("inter_jens_datafiles/bloomTimingGlob_1998_2024.RDS")
i23 <- readRDS("inter_jens_datafiles/iceRetreatTiming_1998_2024.RDS")
...
png(filename="Chla/ESP/2024_indicators/Fig1_bloomtype_mapESP_crab.png",width = 1600, height = 1200,res=120)
plot(map_bloomtype)
dev.off()
...
png(filename="Chla/ESP/2024_indicators/Fig2_bloomtype_timeseriesESP_crab_middle_outer.png",width = 1600, height = 1200,res=120)
plot(bloomtype_TS)
dev.off()


write_csv(wide_type, file='Chla/ESP/2024_indicators/bloom_type_ESP_crab_middle_outer_with2024.csv')
