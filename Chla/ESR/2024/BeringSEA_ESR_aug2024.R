...
# 
bs <- readRDS("inter_jens_datafiles/globcolour_24augSQL.RDS")
head(bs)
...
color_filler<-rep(c(rep('dodgerblue',26),'blue'),8) # fix here - when more years are added # 
...
# save plot 
# png(filename="Chla/ESR/2024/newFig2_satellite_Chla_ESR_EBS.png",width = 1600, height = 1100,res=120)
# plot(fig2)
# dev.off()
...
fig3
# 
# png(filename="Chla/ESR/2024/Fig3_satellite_Chla_ESR_EBS_tileplot60_300.png",width = 1600, height = 1200,res=120)
# plot(fig3)
# dev.off()
...
##
##
bl <- readRDS("inter_jens_datafiles/bloomTimingGlob_1998_2024.RDS")
...
mor_m2<-jnd_tbl_m2
dummy_year<-data.frame(1998:2024)
...
mooring$prim_hybrid[54]<-136 # day of year - based on Prawler data
...
ggplot(sat,aes(avg_peak, year)) + 
  ...
  xlim(70, 190)+
  scale_y_continuous(limits = c(1998,2024), breaks = seq(1998,2024,2))+
