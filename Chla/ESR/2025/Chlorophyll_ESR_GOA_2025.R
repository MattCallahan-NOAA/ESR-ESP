...
png("ESR/2025/Figure_1_GOA.png",width=8,height=6,units="in",res=300)
plotdat %>% 
  ggplot() + 
...
png("ESR/2025/Figure_2_GOA.png",width=8,height=6,units="in",res=300)
data %>% 
  #filter(month%in%(3:6)) %>% 
...
png("ESR/2025/Chla_annual_lines.png",width=7,height=5,units="in",res=300)
ggplot() +
...
png("ESR/2025/Chla_annual_lines_smoothed.png",width=7,height=5,units="in",res=300)
ggplot() +
...
# plot all years
png("ESR/2025/Chla_yearbyyear_lines.png",width=7,height=20,units="in",res=300)
ggplot() +
  geom_line(data=data,
